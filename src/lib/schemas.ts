...
export const profileSchema = z.object({
  ...
  postalCode: z.string().regex(edmontonPostalCodeRegex, 'We only deliver to Edmonton (postal codes starting with T5 or T6)'),
...
export const TIER_CONFIG = {
  basic: { name: 'Basic Box', price: 20, maxItems: 3 },
